...
const Groceries = () => {
  ...
  return (
    <div className="w-full py-4 sm:py-6 md:py-8 px-3 sm:px-4 md:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
      ...
      {notification && (
        <div
          className={`fixed top-4 right-4 px-6 py-3 rounded-lg shadow-lg text-white font-semibold z-50 ${
                ...
                <div className="relative overflow-hidden flex-shrink-0">
                  ...
                  <div className="absolute bottom-3 right-3 flex gap-2 sm:opacity-0 sm:group-hover:opacity-100 transition-all duration-300">
                    <button
                      ...
                      className={`w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center shadow-md hover:scale-110 active:scale-95 transition-all ${
