...
const Card = () => {
  ...
  return (
    <div className="w-full py-4 sm:py-6 md:py-8 px-3 sm:px-4 md:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
      ...
      {notification && (
        <div
          className={`fixed top-4 right-4 px-4 py-3 rounded-lg text-white font-medium z-50 animate-pulse ${
                ...
                <div className="p-3 sm:p-4 md:p-5 flex-1 flex flex-col">
                  ...
                  <div className="flex items-center justify-between mt-auto pt-2 border-t border-gray-100">
                    ...
                    <button
                      ...
                      className="flex items-center justify-center bg-purple-600 hover:bg-purple-700 text-white p-2 sm:px-3 sm:py-2 rounded-lg transition-colors active:scale-95 flex-shrink-0 ml-2"
                      title="Add to cart"
                    >
